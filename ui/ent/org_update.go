...
func (_u *OrgUpdate) SetTrafficRetentionDays(v int) *OrgUpdate {
	_u.mutation.ResetTrafficRetentionDays()
	_u.mutation.SetTrafficRetentionDays(v)
	return _u
}
...
func (_u *OrgUpdate) AddTrafficRetentionDays(v int) *OrgUpdate {
	_u.mutation.AddTrafficRetentionDays(v)
	return _u
}

// SetMaxProxies sets the "max_proxies" field.
func (_u *OrgUpdate) SetMaxProxies(v int) *OrgUpdate {
	_u.mutation.ResetMaxProxies()
	_u.mutation.SetMaxProxies(v)
	return _u
}
...
func (_u *OrgUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.TrafficRetentionDays(); ok {
		_spec.SetField(org.FieldTrafficRetentionDays, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedTrafficRetentionDays(); ok {
		_spec.AddField(org.FieldTrafficRetentionDays, field.TypeInt, value)
	}
	if value, ok := _u.mutation.MaxProxies(); ok {
		_spec.SetField(org.FieldMaxProxies, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedMaxProxies(); ok {
		_spec.AddField(org.FieldMaxProxies, field.TypeInt, value)
	}

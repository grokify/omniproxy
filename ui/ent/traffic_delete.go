...
func (_d *TrafficDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(traffic.Table, sqlgraph.NewFieldSpec(traffic.FieldID, field.TypeInt))
...
// Where appends a list predicates to the TrafficDelete builder.
func (_d *TrafficDeleteOne) Where(ps ...predicate.Traffic) *TrafficDeleteOne {
...
func (_d *TrafficDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{traffic.Label}
	default:
		return nil
	}
}
